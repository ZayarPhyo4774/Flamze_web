...
export const translations = {
  en: {
    ...
    landing: {
      ...
      locationsEyebrow: "Find Flamze",
      locationsTitle: "Branch Locations",
      locationsDescription:
        "Choose the nearest Flamze branch, check the opening hours, and get directions before you visit.",
      ...
      footerLocation: "Yangon & Mandalay, Myanmar",
  ...
  my: {
    ...
    landing: {
      ...
      locationsEyebrow: "Flamze ကို ရှာဖွေပါ",
      locationsTitle: "ဆိုင်ခွဲ တည်နေရာများ",
      locationsDescription:
        "သင့်အနီးဆုံး Flamze ဆိုင်ခွဲကို ရွေးချယ်ပြီး ဖွင့်ချိန်နှင့် လမ်းညွှန်ကို ကြည့်ရှုပါ။",
      ...
      aboutEyebrow: "ကျွန်ုပ်တို့၏ ဇာတ်လမ်း",
      ...
      footerLocation: "ရန်ကုန်နှင့် မန္တလေး၊ မြန်မာ",
    ...
    menu: {
      ...
      noBranch: "ဌာနခွဲ မသတ်မှတ်ထားပါ။ QR code မှန်ကန်စွာ စкан်ပါ။",
      error: "တစ်ခုခု မှားယွင်းနေပါသည်",
      backHome: "← ပင်မစာမျက်နှာသို့",
      backBranches: "ဌာနခွဲများ",
      noImage: "ပုံ မရှိပါ",
    },
    admin: {
      signOut: "ထွက်ရန်",
