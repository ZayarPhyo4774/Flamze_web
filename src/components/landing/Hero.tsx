...
export function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-28 text-center"
    >
      <Image
      ...
      <div className="relative z-10 mx-auto max-w-5xl animate-hero-fade">
        ...
        <h1 className="text-balance text-5xl font-black uppercase leading-[0.95] tracking-[0.04em] text-white sm:text-7xl lg:text-8xl">
          {t.hero.title}
        </h1>
